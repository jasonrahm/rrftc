...
class MatchReportingForm(Form):
    ...
    a_climbers = SelectField('Deliver climbers?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    beacon = SelectField('Push beacon?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    a_park = SelectField('Highest parking level?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    t_climbers = SelectField('Deliver climbers?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    score = SelectField('Did the robot score?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    cycles = SelectField('How many scoring cycles?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    scorelow = SelectField('Score in the low zone?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    scoremid = SelectField('Score in the mid zone?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    scorehigh = SelectField('Score in the high zone?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    lowclimber = SelectField('Release low climber?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    midclimber = SelectField('Release mid climber?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    highclimber = SelectField('Release high climber?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    t_park = SelectField('Highest parking level?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    hang = SelectField('Did the robot hang?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    allclear = SelectField('Did the robot trigger the all clear?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
...
class PitReportingForm(Form):
    competition = QuerySelectField(query_factory=lambda: Competition.query.all(), get_label='Name')
    auto_offense = SelectField('Autonomous?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    auto_defense = SelectField('Defensive Autonomous?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    a_climbers = SelectField('Deliver Climbers?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    beacon = SelectField('Push Beacon?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    a_floorpark = SelectField('Park on Floor?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    a_lowpark = SelectField('Park on Low Zone?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    a_midpark = SelectField('Park on Mid Zone?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    a_highpark = SelectField('Park on High Zone?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    cycles = SelectField('Debris Scoring Cycles', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    scorelow = SelectField('Score in Low Zone?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    scoremid = SelectField('Score in Mid Zone?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    scorehigh = SelectField('Score in High Zone?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    t_climbers = SelectField('Deliver Climbers?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    lowclimber = SelectField('Release Low Climber', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    midclimber = SelectField('Release Mid Climber?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    highclimber = SelectField('Release High Climber?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    t_floorpark = SelectField('Park on Floor?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    t_lowpark = SelectField('Park on Low Zone?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    t_midpark = SelectField('Park on Mid Zone?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    t_highpark = SelectField('Park on High Zone?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    hang = SelectField('Can it Hang?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
    allclear = SelectField('Trigger All Clear?', choices=[(0,'Ignore'),(1,'Not Important'),(3,'Important'),(9,'Critical')], coerce=int)
